...
export default function Login() {
  return (
    <main className="space-y-10 bg-gradient-circle bg-cover bg-no-repeat">
      ...
      <div className="w-full max-w-full mx-auto text-center mt-10">
        ...
        Be<span className="underline decoration-complementary-lighter decoration-8">m-vin</span>do d<span className="bg-accent-lighter">e vol</span>ta!
        </h1>
      </div>
      ...
      <div className="w-full max-w-full mx-auto flex flex-row flex-wrap justify-center mt-8">
        <div className="basis-5/12 b-2 border-sky-700">
          <div className="card shadow-xl shadow-slate-400 p-8 max-w-md mx-auto">
